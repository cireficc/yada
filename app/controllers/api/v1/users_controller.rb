module Api
  module V1
    ...
    class UsersController < ApplicationController
      ...
      # @required [Integer] password_confirmation Confirmation of the
      #                     password
      ...
      # @required [Integer] relationship_status The User's relationship status
      # @required [Integer] relationship_type The User's relationship type
      # @required [Integer] longest_relationship The User's longest
      #                     relationship
      ...
      # @required [Integer] religion_importance How important the User's
      #                     religion is to them
      ...
      # @required [String] catch The User's short phrase to catch a potential
      #                    match's attention
      # @required [String] summary The summary of the User
      # @required [String] current_life What the User is doing currently in
      #                    their life
      ...
      # @required [String] talk_more A potential match should message the User
      # @required [Integer] gender_interest The genders that the User is
      #                     interested in
      # @required [Integer] age_min The minimum age the User wants to match
      # @required [Integer] age_max The maximum age the User wants to match
      # @required [Boolean] desire_single Whether or not the User desires
      #                     matches that are single
      # @required [Boolean] desire_near Whether or not the User desires matches
      #                     near to them
      # @required [String[]] relationship_interest The User's relationship
      #                      interests
      #
      ...
      def user_update_params
        valid_params = [:username, :email, :name, :birthdate,
                        :relationship_status, :relationship_type,
                        :longest_relationship, :height, :body_type,
                        :hair_color, :eye_color, :diet, :smoking, :drinking,
                        :drugs, :religion, :religion_importance, :zodiac_sign,
                        :education, :education_status, :ambitiousness,
                        :has_children, :wants_children, :catch, :summary,
                        :current_life, :free_time, :favorite, :most_important,
                        :talk_more, :gender_interest, :age_min, :age_max,
                        :desire_single, :desire_near, :tag_list,
                        :sexual_gender_list, :sexual_orientation_list,
                        :pet_list, :interest_list, ethnicity: [],
